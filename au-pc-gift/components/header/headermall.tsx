...
// import { fontiCiel } from "@/components/fonts/fonts";
type TokenProps = {
  tokenName: string;
  tokenValue: string;
};
...
export const HeaderDki = ({ token }: HeaderProps) => {
    const [open, setOpen] = useState<boolean>(false);
  let menuRef = useRef<any>();
  // const fontIce = `${fontiCiel.variable}`;
  ...
  useEffect(() => {
    ...
    return (
        <div className="bg-[#fff]  border-b-[1px] border-[#000]">
        <div className="mx-auto px-[16px] h-[54px] flex items-center justify-between max-w-[1200px] lg:h-[71px] relative ">
          ...
          <div className="lg:hidden logged">
            <a
              href="#"
        ...
        <div className="hidden lg:block absolute top-0 w-full h-[71px] bg-[#ffffffd9] list-menu">
          <div className="mx-auto max-w-[1200px] grid grid-cols-7 text-[#4A4A4A] wrapper-lst-menu">
            ...
            <a href="#" className="block pt-[15px] clip-logo before:bg-background-k3 clip-logo">
            <span className="path-outside-logo hidden lg:block">
                <span className="path-inside-logo"></span>
              </span>
              <img
                alt="Game Audition"
                width={71}
